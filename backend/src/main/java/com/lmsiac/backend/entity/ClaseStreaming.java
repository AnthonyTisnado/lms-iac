...
@Entity
@Table(name = "clases_streaming")
public class ClaseStreaming {
    ...
    @Column(name = "enlace_streaming", nullable = false)
    ...
    public String getEnlaceStreaming() { return enlaceStreaming; }
    public void setEnlaceStreaming(String enlaceStreaming) { this.enlaceStreaming = enlaceStreaming; }
